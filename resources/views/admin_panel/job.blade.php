...
<div class="w-full flex justify-center">
    <form action="{{ route('add_job_post') }}" method="POST" class="w-full p-8 flex flex-col space-y-4 items-center">
        @csrf
        ...
        <select size="3" name="roles[]" class="w-full p-2 border-b border-black">
